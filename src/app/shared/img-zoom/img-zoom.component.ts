import { Component, OnInit, Renderer2, ElementRef, AfterViewInit, Input, ViewChild } from '@angular/core';
...
export class ImgZoomComponent implements OnInit {
   ...
   img: any; lens: any; result: any; cx: any; cy: any; container : any;
   hide = true;
   ...
   @ViewChild('img') imgElmRef:any = ElementRef;
   @ViewChild('result') resultElmRef:any = ElementRef;
   @ViewChild('container') containerElmRef:any = ElementRef;
